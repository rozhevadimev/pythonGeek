...
rus = {1:'АВЕИНОРСТ',
      	...
      	8:'ШЭЮ',
      	10:'ФЩЪ'}
N = (int(input('Введите 1 или 0: если введёте 0 - английский язык, если введёте 1 - русский язык: ')))
word = input('Введите слово: ').upper()
if N == 0:
	print('За это слово получаем', sum([k for i in word for k, v in eng.items() if i in v]), 'очков.')
elif N == 1:
	print('За это слово получаем', sum([k for i in word for k, v in rus.items() if i in v]), 'очков.')