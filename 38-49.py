# Задание 49. Создать телефонный справочник с возможностью импорта и
...
# Задание 38. Дополнить телефонный справочник возможностью изменения и
# удаления данных. Пользователь также может ввести имя или фамилию,
# и Вы должны реализовать функционал для изменения и удаления данных

def choose_action(phonebook):
    while True:
        print('Какую запись Вы хотите внести, изменить или удалить?')
...
4 - Изменить контакт\n5 - Удалить контакт\n6 - Просмотреть все контакты\n0 - Выйти из приложения\n')
        ...
        if user_choice == '1':
            ...
            print('Вы вышли из электронного справочника')
            break
        else:
            print('Команда набрана не правильно!')
            print()
            continue
...
def search_to_modify(contact_list: list):
    ...
    if len(search_result) == 1:
        ...
        num_count = int(input('Выберите номер контакта, который нужно изменить или удалить: '))
...
def change_phone_number(file_name):
    ...
    print('В какое поле  справочника Вы хотите внести изменения?')
